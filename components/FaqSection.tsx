    ...
    <section className="py-10 relative overflow-hidden">
      ...
      <div className="text-center  relative z-10 max-w-4xl mx-auto px-4">
        ...
        <motion.h2
          ...
          viewport={{ once: true }}
          className="relative flex items-center justify-center text-2xl sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 mb-8 md:mb-12"
        >
          {/* Left line */}
