  ...
  return (
    <section className="w-full py-10 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <h2 className="relative flex items-center justify-center text-2xl sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 mb-10">
