  ...
  return (
    <main className="min-h-screen pt-20">
      ...
      <section
        ...
        style={{
            backgroundImage: "url('/images/product-screen.png')",
        ...
        >
            ...
            II Deck, III Deck, IV Deck Vibrating screens available in both type Eccentric type and Cardan type with trolley bottom.
            </p>
        </motion.div>
