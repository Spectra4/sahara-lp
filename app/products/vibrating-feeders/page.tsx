  ...
  return (
    <main className="min-h-screen pt-20">
      ...
      <section
        ...
        style={{
            backgroundImage: "url('/images/hero-crusher.png')",
        ...
        >
            ...
            <span className="block text-blue-400 mt-2 text-lg md:text-xl lg:text-2xl">
                (Eccentric Shaft and Vibro Feeder)
            </span>
            </h1>
            ...
            Engineered for smooth, controlled feeding to enhance plant performance and stability.
            </p>
        </motion.div>
